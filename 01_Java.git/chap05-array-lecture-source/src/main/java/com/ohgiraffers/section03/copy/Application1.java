...
public class Application1 {
    public static void main(String[] args) {
        ...
        * */
        ...
        System.out.println("값 변경 전 origin : " + originArr[4]);
        System.out.println("값 변경 전 copy : " + copyArr[4]);

        copyArr[4] = 90;
        System.out.println("값 변경 후 origin : " + originArr[4] );
        System.out.println("값 변경 후 copy : " + copyArr[4] );
...
//
//        String[] lunch = new String[] {"순두부찌개" , "연어포케" , "떡만둣국"};
//        System.out.println("getArr()의 배열 hashCode() : " + getArr().hashCode());
//
//        return lunch;
//    }
}
