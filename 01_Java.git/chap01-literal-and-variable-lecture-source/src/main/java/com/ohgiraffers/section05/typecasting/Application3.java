...
//        int isum = inum + lnum;     //그냥은 안 된다. 두 자료형의 연산 결과는 더 큰 쪽 자료형인 long이 되고, long형 값은 int형 변수에 담길 수 없다.
        int isum = inum + (int)lnum;        //long형을 int형으로 강제 형변환 한다. (큰->작)
        System.out.println("isum : " + isum);

        int isum2 = (int)(inum + lnum);     //두 수의 연산 결과를 int형으로 변환 한다.
        System.out.println("isum2 : " + isum2);

        long isum3 = inum + lnum;       //결과 값을 long형 자료형으로 받는다. (자동 형변환 이용, 작->큰)
