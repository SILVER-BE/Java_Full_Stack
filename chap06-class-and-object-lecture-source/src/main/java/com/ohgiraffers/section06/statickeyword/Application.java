...
public class Application {
    public static void main(String[] args) {
        ...
        * 의도적으로 static 키워드를 사용하는 대표적인 예는 singleton 객체를 생성할 때이다. */
        ...
        System.out.println(sft2.getNonStaticCount());   //0, 공유 X
        System.out.println(sft2.getStaticCount());      //1, 공유.. 프로그램 종료할 때까지 공유
        ...
        /* static 메소드 호출 */
        smt.staticMethod();     // -->  호출 가능, but 올바른 방법 X 권장하지 않음
