...
//        iarr3 = new int[][3];   //주소를 묶어서 관리할 배열의 크기를 지정하지 않으면 에러
        ...
        for(int i = 0; i < iarr2.length; i++) {
            System.out.println(iarr2[i]);   // null --> 아무것도 참조하지 않고 있다 [i][x]
        }
        ...
        * */
        ...
        for(int i = 0; i < iarr3.length; i++) {
            ...
            System.out.println("iarr3[" + i + "].lenght : " + iarr3[i].length);
        }
        ...
        int[][] iarr6 = {{111,222}, {333,444,555,666,777,888,999}, {101,102,103,104,105}}; //가변배열
