...
public class Application1 {
    public static void main(String[] args) {
        ...
        *   2-2.
        ...
        /* 필기. 점점 더 큰 자료형으로 데이터를 옮겨도 문제 없이 자동 형변환 처리 된다. byte>short>int>long */
        byte bnum = 1;
        short snum = bnum;
        int inum = snum;
        long lnum = inum;
...
//        int result1 = num1 + num2;        //자동으로 큰 쪽 자료형인 long으로 변경 후 계산되기 때문에 int형 변수에 담을 수 없다. (에러)
