...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        Tiger tiger = new Tiger(); //호랑이 인스턴스 생성
        tiger.eat();
        tiger.run();
        tiger.cry();
        tiger.bite();
...
//      ┌자료형(사용자 정의 Class)
        Animal a1 = new Cat(); //Animal이라는 타입에 Cat의 주소 저장
        Animal a2 = new Tiger(); //Animal이라는 타입에 Tiger의 주소 저장
//              └레퍼런스 변수 └주소
...
//        ((Tiger)a1).bite();  <-- 고양이는 호랑이가 될 수 없다.
        ...
        System.out.println("ai이 Tiger 타입인지 확인 : " + (a1 instanceof Tiger));
        System.out.println("ai이 Cat 타입인지 확인 : " + (a1 instanceof Cat));
        ...
        * */
        ...
        Cat cat1 = (Cat)animal1;            //down-casting 명시적 형변환 (묵시적 불가)
//        Cat cat2 = animal2;               //down-casting 묵시적 형변환 안됨
