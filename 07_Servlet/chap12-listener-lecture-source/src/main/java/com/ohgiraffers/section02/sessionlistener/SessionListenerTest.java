...
public class SessionListenerTest implements HttpSessionListener, HttpSessionAttributeListener {
    ...
    public SessionListenerTest() {
        System.out.println("session listener 인스턴스 생성 됨");
    }
    ...
    public void sessionDestroyed(HttpSessionEvent se) {
        System.out.println("session 소멸 됨");
    }

    @Override
    public void attributeAdded(HttpSessionBindingEvent event) {
        System.out.println("session attribute 추가 됨");
        System.out.println("session에 추가된 attr : " + event.getName() + ", " + event.getValue());
    }

    @Override
    public void attributeReplaced(HttpSessionBindingEvent event) {
        System.out.println("session attribute 수정 됨");
    ...
    public void attributeRemoved(HttpSessionBindingEvent event) {
        System.out.println("session attribute 제거 됨");
        System.out.println("session에 제거된 attr : " + event.getName() + ", " + event.getValue());
